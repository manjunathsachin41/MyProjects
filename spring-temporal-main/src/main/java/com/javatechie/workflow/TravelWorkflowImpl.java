...
public class TravelWorkflowImpl implements TravelWorkflow {
	...
	/* https://www.youtube.com/watch?v=zVfOa7z-Gdo
		This example tutorial video link.
	*/
    ...
    public void bookTrip(TravelRequest travelRequest) {
        ...
        try {
            ...
            // Compensate for any error in the previous step.
            ...
            // 24 hours (1 day) -> In realtime, wait for user booking confirmation if you won't
            // get any within 24hr then cancel it
